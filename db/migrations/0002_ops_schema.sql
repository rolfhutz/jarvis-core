-- =====================================================================
-- JARVIS Phase 1.0 - Migration 0002 - Gemeinsames technisches Schema jarvis_ops
--
-- Erzeugt aus: spec/phase-0/jarvis-phase-0/db/002_ops_schema.sql via tools/render_context_schema.py --ops
